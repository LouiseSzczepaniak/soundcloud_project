...
$(function()
{
    ...
    albums = [@foreach ($chansons as $c) "{{$c->nom}}" {{","}}@endforeach "end"],
    trackNames = [@foreach ($chansons as $c) "{{$c->style}}" {{","}}@endforeach "end"],
    albumArtworks = [@foreach ($chansons as $c) "{{"test"}}" {{","}}@endforeach "end"],
    trackUrl = [@foreach ($chansons as $c) "{{$c->url}}" {{","}}@endforeach "end"],
